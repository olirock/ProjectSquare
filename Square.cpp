...
void IMAGENS()
{
    verm1 = IMG_Load("orbeverm.png");
    verm2 = IMG_Load("orbeverm.png");
    verm3 = IMG_Load("orbeverm.png");
    verm4 = IMG_Load("orbeverm.png");
    verm5 = IMG_Load("orbeverm.png");
    verm6 = IMG_Load("orbeverm.png");
    verm7 = IMG_Load("orbeverm.png");
    loadinghud = IMG_Load("carregando.png");
    WeWe = IMG_Load("wewe.png");
    recordeshud = IMG_Load("recordes.png");
    historia = IMG_Load("historia.png");
    aberturadome = IMG_Load("dome_abertura.png");
    icongo = IMG_Load("orbe.png");
    jogarnovbut = IMG_Load("JOGARbotao.png");
    voltaraomenu = IMG_Load("voltaraomenu.png");
    gameover = IMG_Load("gameover.png");
    sairbut = IMG_Load("SAIRbotao.png");
    recorbut = IMG_Load("RECORDESbotao.png");
    icon = IMG_Load("orbe.png");
    menuhud = IMG_Load("menu.png");
    creditoshud = IMG_Load("credito.png");
    tutorialhud = IMG_Load("tutorial.png");
    jogarbut = IMG_Load("JOGARbotao.png");
    credbut = IMG_Load("CREDITOSbotao.png");
    tutobut = IMG_Load("TUTORIALbotao.png");
    arma = IMG_Load("orbe.png");
    arma2 = IMG_Load("orbe.png");
    arma3 = IMG_Load("orbe.png");
    HUD = IMG_Load("hud.png");
    squara = IMG_Load("quadrada.png");
    triangulo = IMG_Load("vilao.png");
    pilhatoras = IMG_Load("tora-pilha.png");
    square = IMG_Load("direita.png");
    background = IMG_Load("fundo.png");
    background2 = IMG_Load("fundofase2.png");
    background3 = IMG_Load("fundofase3.png");
    escada1 = IMG_Load("escada-floresta.png");
    plataforma1 = IMG_Load("plataformafloresta.png");
    plataforma2 = IMG_Load("plataforma-grama.png");
    rec = IMG_Load("2.png");
    rec2 = IMG_Load("2.png");
    rec3 = IMG_Load("2.png");
    rec4 = IMG_Load("2.png");
    rec5= IMG_Load("2.png");
    rec6 = IMG_Load("2.png");
    tampadireita = IMG_Load("tampadireita.png");
    tampaesquerda = IMG_Load("tampaesquerda.png");
    aberturaisaac = IMG_Load("newabertura.png");
    quebrada1 = IMG_Load("escada-q1.png");
    quebrada2 = IMG_Load("escada-q2.png");
    sobedesce = IMG_Load("sobedesce.png");
...
void sons()
{
    ...
    Mix_Volume(3,128);
    Mix_VolumeMusic(90);
    efeito_1 = Mix_LoadWAV("menu.wav");
    efeito_2 = Mix_LoadWAV("Jump.wav");
    efeito_3 = Mix_LoadWAV("Morte.ogg");
    game_over = Mix_LoadWAV("gameover.ogg");
    abertura_isaac = Mix_LoadMUS("aberturaisaac.mp3");
    dome = Mix_LoadMUS("dome.ogg");
    menu_princ = Mix_LoadMUS("menuprincipal.ogg");
    recordes_1 = Mix_LoadMUS("recorde.ogg");
    historia_1 = Mix_LoadMUS("historia.ogg");
    venceu = Mix_LoadMUS("youwin.ogg");
    jogo_rodando = Mix_LoadMUS("jogando.ogg");
    creditos_1 = Mix_LoadMUS("creditos.ogg");
    tutorial1 = Mix_LoadMUS("tutorial.ogg");
    wewe = Mix_LoadMUS("youwin.ogg");
}
...
void escrever_recordes()//escrever record no menu
{
    ...
    fonte = TTF_OpenFont("Jazz_Ball_Regular.ttf",20);
    char nome_1[50],nome_2[50],nome_3[50],nome_4[50],nome_5[50];
    ...
    sprintf(pont_1,"%.2f", score_1);
    sprintf(pont_2,"%.2f", score_2);
    sprintf(pont_3,"%.2f", score_3);
    sprintf(pont_4,"%.2f", score_4);

    desenhaTexto(nome_1, screen, 180, 200, cor);
    desenhaTexto(pont_1, screen, 300, 200, cor);
    desenhaTexto(nome_2, screen, 180, 270, cor);
    desenhaTexto(pont_2, screen, 300, 270, cor);
    desenhaTexto(nome_3, screen, 180, 340, cor);
    desenhaTexto(pont_3, screen, 300, 340, cor);
...
//-------------------------------------------------------------//
    SDL_Color cor = {255,255,255};
    fonte = TTF_OpenFont("Jazz_Ball_Regular.ttf",35);//para o player escrever o nome
    SDL_BlitSurface(recordeshud, 0, screen, 0);
    ...
    while(escreve==0)
    {
        ...
        SDL_BlitSurface(recordeshud, 0, screen, 0);
        desenhaTexto(aux,screen,281,215,cor);
...
void INICIALIZACAO()
{
    ...
    TTF_Init();
    SDL_WM_SetCaption("Project Square", NULL);
        ...
        if(event.type == SDL_KEYDOWN)
        {
            switch(event.key.keysym.sym)
            {
                ...
                if((COLISAO(player, obj_escada1) && player.dy<=559 && player.dy>=476) || (COLISAO(player, obj_escada2) && player.dy<=471 && player.dy>=387) || (COLISAO(player, obj_escada3) && player.dy<=384 && player.dy>=299 ) || (COLISAO(player, obj_escada4) && player.dy<=295 && player.dy>=211) || (COLISAO(player, obj_escada5) && player.dy<=208 && player.dy>=123))
                   ...
                   Esquerda = 1;
                    break;
                case SDLK_UP:if(!pula)Cima = 1;
                     break;
                case SDLK_DOWN:if(!pula)Baixo=1;
                     break;
                 case SDLK_SPACE:
